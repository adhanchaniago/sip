				...
				<div class="box-body">
					...
					<form class="form-horizontal"  method="POST" action="" enctype = "multipart/form-data">
						<div class="form-group">
								...
								<div class="col-sm-37" style="margin-left: -6%;">
										<input type="text" name="" id="#" value = "<?php echo $p['nama_pelanggan']?>" autocomplete="off" readonly class="form-control" placeholder = " Kategori" >
							...
							<label class="col-sm-40 control-label"> No Invoice </label>
								<div class="col-sm-37" style="margin-left: -6%;">
										<input type="text" name="" id="no_jl" autocomplete="off"  class="form-control" placeholder = " No Jual" autofocus tabindex = "1">
						   ...
						   <div class="form-group">
								...
								<div class="col-sm-33" style="width:750px">
										<input type="text"  name="keterangan" id="ket"  autocomplete="off" tabindex = "11" class="form-control" placeholder = "Keterangan (F2)" onkeyup=" this.value=this.value.toUpperCase();">
								</div>
							</div>
							<div class="col-sm-31">
								<br>
								...
								<?php		
									...
									$query = "SELECT tb_detail_penjualan.no_jual,tb_detail_penjualan.tgl,tb_detail_penjualan.id_barang,tb_detail_penjualan.qtyb,tb_detail_penjualan.satuan_besar,tb_detail_penjualan.harga_beli,tb_detail_penjualan.disc,tb_detail_penjualan.disc1,tb_barang.nama_barang FROM tb_detail_penjualan INNER JOIN tb_barang ON tb_detail_penjualan.id_barang = tb_barang.id_barang WHERE tb_detail_penjualan.id_pelanggan = '$id_pelanggan' ORDER BY tgl DESC";
									$cari = $this->db->query($query);
									$cari->num_rows();
								
								 ?>
						 	  <table id = "example" class="table table-condensed" style="width:500px">
						   <thead bgcolor="#66CCFF">
				                <tr>
								<td width = "10px" ><b>No</b></td>
								<td width = "10px" ><b>Tanggal</b></td>
								<td width = "100px" ><b>Nama Barang</b></td>
								<td  width = "100px"><b>QTY</b></td>
								<td  align="right" width = "80px"><b>Satuan Besar</b></td>
								<td  align="right" width = "80px"><b>Harga Beli</b></td>	
								</tr>
								</thead> 
								<tbody>
								<?php 
								...
								<tr>
								<td><?php echo $no;?></td>
								<td><?php echo date('d-m-Y',strtotime($f['tgl']));?></td>
							...
							<div class="col-sm-41 tampildata1">
										...
										<a href = "<?php echo base_url();?>Penjualan/riset_retur" class = "btn btn-sm btn-danger"  tabindex="31">Cancel</a>
	...
	function tampiltmp(){			
	   ...
	   $('#btn_simpan').on('click',function(){
           ...
           // var qik			=$('#Q_IK').val();
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url();?>Penjualan/input_detail_retur2",
                data : {idbarang:idbarang,idpelanggan:idpelanggan,qtybes:qtybes,satuanbes:satuanbes,modal:modal,hargabeli:hargabeli,disc:disc,disc1:disc1}, //dihapus,disc2:disc2
                success: function(data){
                    $('[name="idbarang"]').val("");
                    $('[name="namabarang"]').val("");
                    $('[name="qtybes"]').val("");
