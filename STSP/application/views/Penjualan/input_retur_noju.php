 	...
 	<div class = "row " >
 		...
 		<section class="col-lg-12 connectedSortable">
 			<div class="box box-primary" > 
 				<h3 class="box-title" style="margin-top:4px;margin-bottom:-19px;padding-bottom:4px;">Retur Sales Order</h3>
 			</div>
 			<div class="box-body">
 				<div class="col-md-7">
 					...
 					<div class="col-md-9"  style="margin-top: -76px;">
 						<div class="col-sm-30" style="width:330px" >
...
<script>
	...
	$(function(){
		...
		$('#nama_barang').autocomplete({
			serviceUrl: site+'Penjualan/get_data_retur_nojul/'+noju,
...
<script type="text/javascript">
	...
	function tampiltmp(){			
		...
		$('.tampildata').load("<?php echo base_url();?>Penjualan/view_retur_total");
	}
