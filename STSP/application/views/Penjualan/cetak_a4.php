				...
				<div class="box-body" >
					...
					<div class="form-group"  style="margin-left:64px;">
							<div class="col-sm-42" style ="width:18%">
								<td height="40" colspan="6" align="center" ><b><font color="#000000" style="font-size: 140%" class="html1"> &nbspSTS </font></b></td>
							</div>
...
<section class="col-lg-7 connectedSortable" style="margin-left: -964px;margin-top: 69px; width: 71%;" >
<table align="left" width="900px">
	...
	<td height="10"> </td>
					...
					<div class="form-group" id="FC">
							...
							<div class="form-group" id="FC" style="margin-top: 5px;">
								<td> <?php echo $d['tgl_invoice'];?></td>
							<div class="col-sm-42" >
								<td>Tgl </td>
							</div>
							</div>
							<div id="FD" style="border-top: 2px solid #000000; margin-top: 1em; padding-top: 1em;margin-top:10px"></div>
