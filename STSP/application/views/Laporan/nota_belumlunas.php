...
$bul=0;
		...
		where customer.id='$id_karyawan' and jual.bayar = '0'";
...
<table align="center" cellpadding="0" width="533px" style="margin-top: 15px;">
	<tr bgcolor="#fff">
		<td height="20" colspan="5" align="center" id="FB" ><b><font color="#000000"> &nbsp Laporan Nota Belum Bayar</font></b></td>
	</tr>
	<tr bgcolor="#fff">
	</tr>
	<tr bgcolor="#fff">
...
<section class="col-lg-6 connectedSortable" >
		<table  align="left" cellpadding="0" cellspacing="0" class="all" width="1250px"id="fC" style="margin-left:-5.5%">
