 ...
 <div class="modal fade" id="konfirmasi_hapus" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<section id="example2" class="col-lg-12 connectedSortable">
			...
			<div class="nav-tabs-custom">
				...
				<li class="active"><a href="<?php echo base_url(); ?>Laporan/lap_transaksib" data-toggle="tab"><i class="fa fa-money"></i> <b> Transaksi Pembelian Perhari</b></a></li>
...
<?php		
 ...
 ?>
			...
			<form class="form-horizontal" action="<?php echo base_url(); ?>Laporan/lap_transaksibeli" method="GET">
				<div class="form-group">
								...
								<div class="input-group">
									...
									<a href = "<?php echo base_url('Laporan/transaksib?&tanggal_dari='.$tanggal_dari.'&tanggal_sampai='.$tanggal_sampai.'');?>" class = "btn btn-sm btn-success" target = "" style="margin-left:703%;margin-top: -52px;">cetak</a>
								</div>
								</div>
							</div>
				</form>
			...
			<tr bgcolor="#fff">
				<td height="20" colspan="5" align="center" id="FB" ><b><font color="#000000" size = "3"> &nbsp Laporan Transaksi Pembelian </font></b></td>
			</tr>
			<tr bgcolor="#fff">
	...
	<?php if($data['kode_mu'] != "RP"){
		echo number_format($data['total_dolar']);
	}else{
		echo "-";
	}?></td>
	<td align="right">
	...
	<tr>
					...
					<tr>
					<td colspan = "11" align = "right"><b>Total Nilai Asing</b></td>
					<td colspan = "2" align = "right"><b><?php if($dolar > 0){
