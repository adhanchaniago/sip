 ...
 <div class="modal fade" id="konfirmasi_hapus" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<section id="example2" class="col-lg-12 connectedSortable">
			...
			<div class="nav-tabs-custom">
				...
				<li class="active"><a href="<?php echo base_url(); ?>Laporan/lap_transaksipbulan"data-toggle="tab" ><i class="fa fa-money"></i> <b> Transaksi Penjualan Pernota</b></a></li>
				  <?php endif;?>
			...
			<?php		
				$query = "SELECT * from tb_penjualans";
		 ...
		 ?>
			...
			<form class="form-horizontal" action="<?php echo base_url(); ?>Laporan/transaksinota" method="GET">
				<div class="form-group">
								<label class="col-sm-40 control-label" style="width :67px;margin-right :1px;margin-left: 7px;">Pelanggan</label>
								<div class="col-sm-37"  style="width :150px">
								<select class="form-control" name = "id_pelanggan" id="#">
										<option value = "">Pilih Pelangan</option>
										<?php foreach ($listpelanggan->result()  as $d){
										?>
										 <option value = "<?php echo $d->id_pelanggan;?>"><?php echo $d->nama_pelanggan;?></option>
										<?php }?>
									</select>
								</div>
								<label class="col-sm-40 control-label" style="width :67px;margin-right :1px;margin-left: 7px;">No Invoice</label>
								<div class="col-sm-37"  style="width :150px">
								<select class="form-control" name = "no_jual" id="#" >
										<option value = "">Pilih Invoice</option>
										<?php foreach ($cari->result()  as $c){
										?>
										 <option value = "<?php echo $c->no_jual;?>"><?php echo $c->no_jual;?>/<?php echo $c->id_pelanggan;?>/<?php echo $c->no_reff;?></option>
										<?php }?>
									</select>
								</div>
