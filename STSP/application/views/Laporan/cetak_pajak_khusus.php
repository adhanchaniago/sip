...
<table align="left" width="900px"  >
	<tr id="fC">
		...
		<td width = "9%"><b>Tgl Invoice</b></td>
		<td width = "15%" align = "center"><b>No Invoice</b></td>
		<td width = "7%" align = "right"><b>Total</b></td>
		<td width = "7%" align = "right"><b>Total DPP</b></td>
		<td width = "7%" align = "right"><b>Total PPN</b></td>
	</tr>
	<tr>
		<td  id="FD"colspan="8"align="right">________________________________________________________________________________________________________________________________________________________________________________________________________________________________________</td>
		<td></td>
		<td></td>
		<td></td>
		<td ></td>
	...
	<tr>
		...
		<td ></td>
							...
							<td width="150"colspan='5' align = "center"></td>
							<td align="right" colspan='2'><b>Grand Total</b></td>
							<td align="right" colspan='1'><?php echo number_format($sub,2)?></td>
							</tr >
							<tr id="fC" height="20px">
							<td width="150"colspan='5' ></td>
							<td align="right" colspan='2' ><b>Total DPP </b></td>
							<td align="right" colspan='1'><?php echo number_format(round($dpp),2)?></td>
							</tr>
							<tr id="fC" height="20px">
							<td width="150"colspan='5' ></td>
							<td align="right" colspan='2' ><b>Total PPN </b></td>
							<td align="right" colspan='1'><?php echo number_format(round($ppn),2)?></td>
							</tr>
</table>	
</body>