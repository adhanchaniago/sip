	...
	<section id="example2" class="col-lg-12 connectedSortable">
		<div class="box box-primary">
			...
			<div class="nav-tabs-custom">
				...
				<li class=""><a href="<?php echo base_url(); ?>Laporan/lap_transaksibulan" ><i class="fa fa-money"></i> <b>Laporan Transaksi Pembelian Perbulan</b></a></li>
				<li class="active"><a href="<?php echo base_url(); ?>Laporan/lap_transaksisupplier"data-toggle="tab" ><i class="fa fa-money"></i> <b>Laporan Transaksi Pembelian Persupplier</b></a></li>
				...
				<li class=""><a href="<?php echo base_url(); ?>Laporan/lap_transaksipbulan" ><i class="fa fa-money"></i> <b>Laporan Transaksi Penjualan Perbulan</b></a></li>
				<li class=""><a href="<?php echo base_url(); ?>Laporan/lap_transaksipelanggan" ><i class="fa fa-money"></i> <b>Laporan Transaksi Penjualan Perpelanggan</b></a></li>
				<?php endif;?>
			...
			<form class="form-horizontal" action="<?php echo base_url(); ?>Laporan/transaksib" method="GET">
