 ...
 <div class="modal fade" id="konfirmasi_hapus" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<section id="example2" class="col-lg-12 connectedSortable">
			...
			<div class="nav-tabs-custom">
				...
				<li class="active"><a href="<?php echo base_url(); ?>Laporan/lap_pajak2" data-toggle="tab"><i class="fa fa-money"></i> <b>Pajak Umum</b></a></li>
			...
			<form class="form-horizontal" action="<?php echo base_url(); ?>Laporan/pajak2" method="GET">
				...
				<div class="form-group">
								...
								<div class="input-group">
									...
									<a href = "<?php echo base_url('Laporan/pajak_cetak?&tanggal_dari='.$tanggal_dari.'&tanggal_sampai='.$tanggal_sampai.'');?>" target = "" class = "btn btn-sm btn-info" style="margin-left:497%;margin-top: -22px;">Cetak</a>
									<a href = "<?php echo base_url('Laporan/pajak?&tanggal_dari='.$tanggal_dari.'&tanggal_sampai='.$tanggal_sampai.'');?>" target = "tampil" class = "btn btn-sm btn-success" style="margin-left:535%;margin-top: -52px;">export csv</a>
								</div>
								</div>
							</div>
				</form>
			...
			<div class="row" style="margin-top: -16px;">
				...
				<tr>
					...
					<td width="10%" align = "center"><b>No Invoice</b></td>
