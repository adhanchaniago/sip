	...
	<section id="example2" class="col-lg-12 connectedSortable">
			...
			<form class="form-horizontal" action="<?php echo base_url(); ?>Laporan/pajak_khusus" method="GET">
				...
				<div class="form-group">
								...
								<div class="col-sm-37"  style="width :150px;margin-left: 139%;margin-top: -34px;">
								<div class="input-group">
									<a href = "<?php echo base_url('Ambil_Pajak/view_pajak')?>" class = "btn btn-sm btn-success">Ambil Pajak</a>
								</div>
								</div>
							</div>
				</form>
