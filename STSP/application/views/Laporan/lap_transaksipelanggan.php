	...
	<section id="example2" class="col-lg-12 connectedSortable">
		<div class="box box-primary">
			...
			<div class="nav-tabs-custom">
				...
				<li class=""><a href="<?php echo base_url(); ?>Laporan/lap_transaksisupplier" ><i class="fa fa-money"></i> <b>Laporan Transaksi Pembelian Persupplier</b></a></li>
				<?php endif;?>
				...
				<li class="active"><a href="<?php echo base_url(); ?>Laporan/lap_transaksipelanggan" data-toggle="tab"><i class="fa fa-money"></i> <b>Laporan Transaksi Penjualan Perpelanggan</b></a></li>
			...
			<form class="form-horizontal" action="<?php echo base_url(); ?>Laporan/transaksi" method="GET">
