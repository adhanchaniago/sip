	...
	<section id="example2" class="col-lg-12 connectedSortable">
			...
			<div class="nav-tabs-custom">
				...
				<?php if ($j->lap_komisi == "Y"): ?>
				  ...
				  <li class="active"><a href="<?php echo base_url(); ?>Laporan/lap_lunas" data-toggle="tab"><i class="fa fa-money"></i> <b>Nota Bayar</b></a></li>
				  <?php endif;?>
				</ul>
			</div>
            <!-- /.box-header -->
			...
			<form class="form-horizontal" action="<?php echo base_url(); ?>Laporan/lunas" method="GET">
