...
<?php		
		...
		$query = "SELECT * from transaksi_dayb  WHERE date_invoice BETWEEN '$tanggal_dari' AND '$tanggal_sampai' order by MID(tgl,4,2)DESC,LEFT(tgl,2)DESC,LEFT(jam,2)DESC,MID(jam,4,2)DESC,RIGHT(jam,2)DESC";
...
<table align="center" cellpadding="0" width="900px" style="margin-top: 15px;">
	<tr bgcolor="#fff">
		<td height="20" colspan="5" align="center" id="FB" class="html1"><b><font color="#000000"> &nbsp Laporan Transaksi Pembelian </font></b></td>
	</tr>
	<tr bgcolor="#fff">
		<td height="10" colspan="5" align="center" id="fC"><b><font color="#000000"> &nbsp <?php echo "Per : ".date('d-m-Y',strtotime($tanggal_dari)); ?> s/d <?php echo date('d-m-Y',strtotime($tanggal_sampai)); ?></font></b></td>
	</tr>
	<tr bgcolor="#fff">
		<td height="20"></td>
	</tr>
 ...
 <?php foreach ($cari1->result()  as $c){
?>
	<tr id="fC">
		<td width = "73%"></td>
		<td align="right" width = "15%"><b>Petty Cash</b></td>
		<td align="right" width = "100%"><b>Sisa</b></td>
	</tr>
	<tr id="fC" >
		<td width = "73%"></td>
		<td align="right" width = "15%"><?php echo "Rp. ", number_format($c->nominal);?></td>
		<td align="right" width = "20%"><?php echo "Rp. ", number_format($c->sisa-$c->kembali);?></td>
	</tr>
 <?php }?>
	</table>
	<br>
<table  align="center" cellpadding="0" cellspacing="0" class="all" width="1250px" style="margin-left: 5px;" >
	<tr id="fC">
		...
		<td align="right" width = "15%"><b>Tips</b></td>
	...
	<td colspan="13" id="fD">________________________________________________________________________________________________________________________________________________________________________________________________________________________________________</td>
		...
		<table  align="center" cellpadding="0" cellspacing="0" class="all" width="1275px"id="fC" >
				<tr id="fC" height="20px">
							...
							<td align="right" colspan='5'><?php if($t > 0){
							...
							<td align="right" >Rp. </td>
							<td align="right" colspan='5'><?php if($b > 0){
							...
							<tr id="fC" height="20px">
							<th  width="550"colspan='10' ></th>
							<th  align="right">Total Tips :</th>
							<td align="right" >Rp. </td>
							<td align="right" colspan='5'><?php if($tip > 0){
							...
							<td align="right" >Rp. </td>
							<td align="right" colspan='5'><?php if($p > 0){
							...
							<td align="right" >Rp. </td>
							<td align="right" colspan='5'><?php if($gr > 0){
							...
							<td align="right" >Rp. </td>
							<td align="right" colspan='5'><?php if($c > 0){
							...
							<td align="right" >Rp. </td>
							<td align="right" colspan='5'><?php if($d > 0){
							...
							<td align="right" >Rp. </td>
							<td align="right" colspan='5'><?php if($tr > 0){
							...
							<td align="right" >Rp. </td>
							<td align="right" colspan='5'><?php if($g > 0){
							...
							<td align="right" >Rp. </td>
							<td align="right" colspan='5'><?php if($s > 0){
