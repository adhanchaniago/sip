...
?>
<section class="col-lg-6 connectedSortable" style="width:1230px">
<table align="center" cellpadding="0" width="533px" style="margin-top: 15px;">
	<tr bgcolor="#fff">
		<td height="20" colspan="5" align="center" id="FB" ><b><font color="#000000"> &nbsp Laporan Saldo Balance</font></b></td>
	</tr>
	<tr bgcolor="#fff">
	</tr>
	<tr bgcolor="#fff">
...
<tr bgcolor="#fff">
	...
	<tr id="fC">
		...
		<td width = "7%"><b>nama sales</b></td>
		<td width = "5%"><b>Tanggal Beli</b></td>
		<td  align="right" width = "5%"><b>Total</b></td>
		<td  align="right" width = "5%"><b>Retur</b></td>
		<td  align="right" width = "5%"><b>Tagihan</b></td>
		<td  align="right" width = "5%"><b>Bayar</b></td>
		<td  align="right" width = "5%"><b>Sisa</b></td>
	</tr>
	<tr>
		<td colspan="10" id="fD">_______________________________________________________________________________________________________________________________________________</td>
	...
	<?php
	$color = "";
	if ($data['bayar'] > 0 or $data['tagihan'] == 0){echo $color = "";}else{  $color = "yellow";}
	?>
	<tr id="fC"  >
	<td><?php echo $no;?></td>
	<td bgcolor = "<?php echo $color;?>"><?php echo $data['no_jual']?></td>
	...
	<td  align="right">
	<?php echo number_format($data['total_retur']);?>
	</td>
	<td  align="right">
	<?php echo number_format($data['tagihan']);?>
	</td>
	<td  align="right">
	<?php echo number_format($data['bayar']);?>
	</td>
	<td  align="right">
	<?php echo number_format($data['sisa']);?>
	</td>
	...
	<tr>
	<tr>
		<td colspan="13" id="fD">_______________________________________________________________________________________________________________________________________________</td>
	</tr>
	<?php
 $query = "SELECT customer.id,jual.no_jual,jual.tgl_buat,jual.total,trimadetail.no_jual as bayar,trima.rebate,trima.tgl_buat as tgl,trimadetail.jumlah from jual 
		inner join customer on jual.id_customer=customer.id  
		inner join trimadetail on jual.no_jual=trimadetail.no_jual
		inner join trima on trimadetail.no_trima=trima.no_trima
		where customer.id='$id_karyawan'";
	$jumlah = $this->db->query($query);
 ?>
<?php 
...
<tr bgcolor="#fff">
	...
	<tr bgcolor="#fff">
		<td height="10" colspan="5"  id="fC"><b><font color="#000000"><?php echo "Nota Sudah Dibayar"?></font></b></td>
	</tr>
	<tr bgcolor="#fff">
		<td height="20"></td>
	</tr>
