...
<section class="col-lg-12 connectedSortable">
						<?php 
						$no_beli		= $this->input->get('no_beli');
						$id_supplier	= $this->input->get('id_supplier');
						
						if($no_beli != ""){
							$no_beli = "WHERE tb_pembelian.no_beli = '$no_beli'";
						}
						if($id_supplier !=  ""){
							$id_supplier = "AND tb_pembelian.id_supplier = '$id_supplier'";
						}
							$query = "SELECT * FROM tb_pembelian INNER JOIN tb_supplier ON tb_pembelian.id_supplier = tb_supplier.id_supplier ".$no_beli.$id_supplier."";
		...
		<div class="box box-primary">
					  ...
					  <table id = "example" class="table table-condensed" >
						   <thead bgcolor="#99FF99">
								...
								<td width = "50px" ><b>No Invoice</b></td>
								<td  align="center" width = "50px"><b>Tgl Invoice</b></td>
...
document.onkeydown = function (e) {
		switch (e.keyCode) {
			...
			case 13:
				...
				setTimeout('self.location.href="<?php echo base_url();?>Pembelian/input_pembelian"', 0);
				break;
