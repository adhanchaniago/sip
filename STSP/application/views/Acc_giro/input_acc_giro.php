 		...
 		<section class="col-lg-6 connectedSortable">
 			<div class="box box-primary">
 				<div class="box-header">
 					<h3 class="box-title"> Input ACC Giro Penerimaan</h3>
 				</div>
 				<div class="box-body">								
 ...
 <script type="text/javascript">
	...
	$(".cekbarang").on("keyup",function(){
 		...
 		$.ajax({
 			type    : 'GET',
 			url     : '<?php echo site_url(); ?>Acc_giro/ceknota',
 			cache   : false,
 ...
 <script type="text/javascript">		
 	...
 	function tampil(){	
 		$(".tampil").load("<?php echo base_url();?>Acc_giro/view_tmp_acc_giro");
 	}

 	function tampil2(){	
 		$(".tampil2").load("<?php echo base_url();?>Acc_giro/view_tmp_belum_acc_giro");
 	}
 	...
 	$('#btn_simpan').on('click',function(){
		...
		if(ceknota == 0){
			  alert("Oops.. Nota Giro Penerimaan Tidak Ada");
			  document.getElementById("no_jual").focus();
			  return false;
		}else{
 		$.ajax({
 			type : "POST",
 			url  : "<?php echo base_url()?>Acc_giro/input_acc_giro",
 			data : {nojual:nojual,idpelanggan:idpelanggan,tgl:tgl,jam:jam,total:total,acc:acc},
