<div class="box box-primary">
	<div class="box-header">
		<h3 class="box-title" style="margin-left: -9px;">Data Belum ACC Giro Penerimaan</h3>
	</div>
	<div class="box-body">
			...
			<table id = "example3" class = "table table-condensed" style = "width:650px;">
				...
				<tbody id = "">
					...
					foreach ($belumacc as $d) { 
						...
						<tr>
							<td><?php echo $no;?></td>
							<td> <?php echo $d['no_bukti']; ?>/<?php echo $d['id_pelanggan']; ?></td>
							<td> <?php echo $d['tgl_bayar']; ?></td>
							<td> <?php echo number_format($d['totalan'],2); ?></td>
