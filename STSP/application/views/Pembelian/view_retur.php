 			...
 			<div class="box box-primary">
 				<div class="nav-tabs-custom">
 					<ul class="nav nav-tabs">
 						<li class=""><a href="<?php echo base_url(); ?>Pembelian/view_pembelian"><i class="fa fa-cart-arrow-down"></i> <b>Data Pembelian</b></a></li>
 						<li class="active"><a href="<?php echo base_url(); ?>Pembelian/view_retur"  data-toggle="tab"><i class="fa fa-mail-forward"></i> <b>Data Retur Pembelian</b></a></li>
 					</ul>
 				</div>
 			</div>
...
<script type="text/javascript">
	...
	$(".detail").click(function(){
		...
		$.ajax({
			type 	:'POST',
			url     :'<?php echo base_url();?>Pembelian/detail_retur_pb',
