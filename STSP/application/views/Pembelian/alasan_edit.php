<form class="form-horizontal"  method="POST" action="<?php echo base_url();?>Pembelian/alasan_edit_pembelian" enctype = "multipart/form-data">
							<div class="form-group">
								...
								<div class="col-sm-5">
										...
										<?php } ?>
										<input type="hidden" value = "<?php echo $autonumber; ?>" name="no_edit" id="#" autocomplete="off" class="form-control" placeholder = "Masukan Alasan">
