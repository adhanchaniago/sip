...
foreach ($list_tmp as $t) { 
	...
	?>
	<?php $total=$total+$hasil7; $dpp = $total / 1.1; $ppn = $dpp * 10/100; } ?> 
	
	<?php 
	$sub=0;$hasil=0;$hasil2=0;$hasil3=0;$hasil4=0;$hasil5=0;$hasil6=0;$hasil7=0;
	foreach ($list_retur as $r) { 
		...
		$hasil7 =$hasil5+$hasil6;
		?>
		<?php $sub=$sub+$hasil7; }?><!-- Asli $hasil5 -->
		<div class="info-box bg-aqua" style="min-height:105px">
			...
			<span class="info-box-number" style=" font-size:23px; padding:36px 0"><?php if($kurs_tukar >1){ echo $simbol?>. <?php echo round($total,2); }
