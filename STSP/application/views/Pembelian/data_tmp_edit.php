<?php 
$total=0; $hasil=0;$hasil2=0;$hasil3=0;$hasil4=0;$hasil5=0;$hasil6=0;$hasil7=0;$dolar=0;$subdolar=0;$hasil_dolar=0;
$no = 1;
foreach ($list_tmp as $t) { 
	...
	<tr>
		...
		<td > 
			<?php if($t['kurs_tukar'] > 1){ 
				echo $t['kode_mu']?>. <?php echo round($t['harga_beli']*$t['qtyb'],2); 
			}else{ 
				echo "Rp. ",number_format($hasil5,2);
			}?>
