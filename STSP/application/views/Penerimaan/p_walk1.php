...
foreach ($list_tmp as $t) { 
	...
	<div class="form-group">
		...
		<div class="col-sm-33">
			...
			<input type="hidden" name=""  readonly id="dpt3" autocomplete="off" class="form-control "  onkeyup="copytextbox12();"  tabindex="26">
		</div>
	</div>
	<div class="form-group">
		...
		<script type="text/javascript">
			$(function(){
				...
				$('#cash,#potongan,#debet,#transfer,#giro,#dpt3').keyup(function(){
					...
					var tot_bayar = (total * 1) - (pot * 1);
					var tb_bayar = parseInt(tot_bayar * 1) - parseInt(cash * 1) - parseInt(debet * 1) - parseInt(transfer * 1) - parseInt(giro * 1) - parseInt(dpt3 * 1);
					if(tb_bayar < 0){
