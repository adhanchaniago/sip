...
<div class="page"> 
<body  onload="window.print();window.location.href = '<?php echo base_url('Penerimaan/view_penerimaan');?>';" class="html"> 
...
<table  align="center"   width="610px" id="FC">
	...
	$query = "SELECT tb_detail_pembayaran.no_bukti,tb_detail_pembayaran.no_jual,tb_detail_pembayaran.total,tb_detail_pembayaran.sisa_bayar,
	tb_detail_pembayaran.bayar,tb_penjualan.no_reff,tb_penjualan.id_pelanggan FROM tb_detail_pembayaran INNER JOIN tb_pembayaran ON 
	tb_detail_pembayaran.no_bukti = tb_pembayaran.no_bukti INNER JOIN tb_penjualan ON tb_detail_pembayaran.no_jual = tb_penjualan.no_jual
	WHERE tb_detail_pembayaran.no_bukti = '$no_bukti'";
