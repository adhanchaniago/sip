 ...
 <body >	
 			...
 			<div class="box box-primary">
 				<div class="box box-primary" style="margin-top: -3px;">
 					<?php if ($j->r_pembelian == "Y"): ?>
 						<a class="pull-right" style="margin-right: 5px;margin-top: 5px;"> <input type="text" id="id_supplier" placeholder="NAMA SUPPLIER" autofocus="" class="form-control" style="margin-top: 2px;"></i></a>
 					<?php endif;?>
 				...
 				<table id = "example" class="table table-condensed">
 					<thead bgcolor="#99FF99">
 						<tr>
 							...
 							<td width = "80px"><b>Nama Supplier</b></td>
 					...
 					<tbody>
 						...
 						$no=1;
 						foreach($Pembayaran->result() as $f){
 							
 							?>
 							<tr  href = "#"  class="detail" data-id = "<?php echo $f->no_bukti; ?>">
 								<td><?php echo $no;?></td>
 								<td><?php echo $f->no_bukti;?>/<?php echo $f->id_supplier;?></td>
 								...
 								<tbody >
 									<tr>
 										...
 										foreach($listpelanggan->result() as $p){
 											...
 											<td align="right"><a href = "<?php echo base_url('Pembayaran/input_pembayaran/'.$p->id_supplier); ?>"><span class = "btn btn-xs btn-success"><i class = "fa fa-plus"></i></span></a></td>
 										</tr>
 										<?php
 									}
 									?>
 	...
 	<script type="text/javascript">
 		...
 		$(".detail").click(function(){
 			...
 			$.ajax({
 				type 	:'POST',
 				url     :'<?php echo base_url();?>Pembayaran/data_pn',
 		...
 		$(".cetak").click(function(){
 			...
 			$.ajax({
 				type 	:'POST',
 				url     :'<?php echo base_url();?>Pembayaran/looping_cetak',
 				data    :'no_bukti='+no_bukti,
 				cache   :false,
 				success :function(respond){
 		...
 		$(function(){
 			$('#id_supplier').autocomplete({
 				serviceUrl: site+'Pembayaran/get_data_supplier/',
 				onSelect: function (suggestion) {
 					window.location.href = "<?php echo base_url();?>Pembayaran/input_pembayaran/"+suggestion.id_supplier;
