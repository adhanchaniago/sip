 ...
 <body class = "tampildata3" onLoad="startTime()">	
 	...
 	<div class = "row">
 		...
 		<section class="col-lg-12 connectedSortable">
 			<div class="box box-primary" > 
 				<h3 class="box-title" style="margin-top: 4px;margin-bottom: -19px;padding-bottom: 4PX;" >Retur Purchase Order</h3>
 			</div>
 			<div class="box-body">
 				<div class="col-md-7">
 					...
 					<div class="col-md-9"  style="margin-top: -78px;">
 						...
 						<div class="col-sm-30"  style="width:120px">
 							...
 							<input type="text"  name="hargabeli1" id="hargabeli" readonly autocomplete="off" class="form-control" placeholder = "HARGA ">
 						...
 						$query = "SELECT tb_detail_pembelianpo.no_beli,tb_detail_pembelianpo.id_barang,
 						tb_detail_pembelianpo.qtyb,tb_detail_pembelianpo.satuan_besar,tb_detail_pembelianpo.harga_beli,
 						tb_detail_pembelianpo.ppn,tb_detail_pembelianpo.disc,disc1,disc2,tb_barang.nama_barang,
 						tb_pembelianpo.no_beli,tb_pembelianpo.ket_retur,tb_pembelianpo.total,ongkir1,tb_pembelianpo.nominal1,
 						tb_pembelianpo.nominal,tb_pembelianpo.tips,tb_pembelianpo.sisa,tb_detail_pembelianpo.kurs_tukar,tb_detail_pembelianpo.kode_mu
 						FROM tb_detail_pembelianpo INNER JOIN tb_barang ON tb_detail_pembelianpo.id_barang = tb_barang.id_barang 
 						INNER JOIN tb_pembelianpo ON tb_detail_pembelianpo.no_beli = tb_pembelianpo.no_beli 
 						WHERE tb_detail_pembelianpo.no_beli = '$no_beli'";
 						...
 						<table id = "example" class="table table-condensed" style="width:700px">
 							...
 							<tbody>
 								...
 								if(isset($cari)){
 									foreach ($cari->result_array() as $f){
 										...
 										<tr>
 											...
 											<td align="right"> <?php if($f['kurs_tukar'] > 1){ echo $f['kode_mu']?>. <?php echo round($dolarss,2); }
 											else{ echo "-";}?></td>
										...
										<input type = "hidden" name = "kode_mu" value = "<?php echo $f['kode_mu']?>">
 										<tr>
 										...
 										<tr>
 											...
 											<td align="right"> <?php if($f['kode_mu'] != "RP"){ echo $f['kode_mu']?>. <?php echo round($dolars,2); }
 											else{ echo "-";}?></td>
 								...
 								<div class="col-md-3" style="margin-top: -9px;">
 									...
 									<textarea style = "display:none;" rows="1"class="form-control" name="kurs_tukar" 		  id="kurs_tukar" style="height: 34px;"readonly requered></textarea>
 										...
 										<table class = "table1">
 											<tr>
 												<td align = "right">
 													...
 													<a href = "<?php echo base_url();?>Purchase_order/riset3" class = "btn btn-sm btn-danger"  tabindex="31">Cancel</a>
 	...
 	<script>
 		...
 		$(function(){
 			...
 			$('#nama_barang').autocomplete({
 				serviceUrl: site+'Purchase_order/get_data_retur/'+nobel,
 				onSelect: function (suggestion) {
 					...
 					$('#hargabeli').val(''+suggestion.harga_beli1);
 	...
 	<script type="text/javascript">
 		...
 		function tampiltmp(){			
 			...
 			$("#tampiltmp").load("<?php echo base_url();?>Purchase_order/view_barang_retur");
 			$('.tampildata').load("<?php echo base_url();?>Purchase_order/view_barang_retur2");
        //$('.tampildata1').load("<?php echo base_url();?>Purchase_order/view_barang_retur3");
    }
    $('#btn_simpan').on('click',function(){
        ...
        if(namabarang == 0){
        	...
        	$.ajax({
        		type : "POST",
        		url  : "<?php echo base_url()?>Purchase_order/input_barang_retur",
...
<script>
	...
	$('body').on('click', '.hapus-barang', function(e){
		...
		$.ajax({
			type: 'post',
			dataType: 'json',
			url : "<?= site_url('Purchase_order/destroy_retur/');?>"+'/'+user+'/'+id_barang,
			success: function(data){
				tampiltmp();
				$('.tampildata').load("<?php echo base_url();?>Purchase_order/view_barang_retur2");
