...
foreach ($listdetail->result() as $t) { 
	...
	$query1 = "SELECT tb_detail_returpo.no_jual, tb_detail_retur.id_barang,nama_barang,tb_detail_retur.qtyb,tb_detail_retur.satuan_besar,tb_detail_retur.harga_beli,tb_detail_retur.disc,
