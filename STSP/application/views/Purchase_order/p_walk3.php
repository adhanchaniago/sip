							...
							<div class="form-group">
								...
								<div class="col-sm-33">
										...
										<input type="text" name=""  id="cashdis" onkeypress='return check_int(event)' autocomplete="off" class="form-control" placeholder = "CASH "  tabindex="21">
							...
							<div class="form-group">
								...
								<div class="col-sm-33" style="width:107px">
										...
										<input type="text"  name=""  id="transferdis" autocomplete="off" class="form-control" placeholder = "TRANSFER " onkeyup="copytextbox8();"  tabindex="24">
								</div>
								<div class="col-sm-33" style="width:74px">
											...
											<input type="text"  name=""  id="bank2dis" autocomplete="off" class="form-control" placeholder = "BANK " onkeyup="copytextbox9(); this.value=this.value.toUpperCase();"  tabindex="25">
								</div>
							</div>
