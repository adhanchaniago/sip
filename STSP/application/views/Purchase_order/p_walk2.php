									...
									foreach ($list_tmp as $t) { 
										...
										<div class="form-group">
											<div class="col-sm-33" >
												<input type="text" name="" id="nominal1" autocomplete="off" class="form-control" onkeyup="copytextbox();" placeholder = "NOMINAL" tabindex="17">
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-38">
										...
										<script type="text/javascript">
											$(function(){
												...
												$('#ongkir1,#nominal1,#nominal').keyup(function(){
