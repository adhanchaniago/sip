...
foreach ($list_tmp as $t) { 
	...
	foreach ($list_tmp as $t) { 
		...
		<div class="form-group" hidden = "">
			...
			<div class="col-sm-33">
				<input type="text" name="" id="total_bayar" readonly  autocomplete="off" class="form-control" placeholder = "Total Bayar ">
		...
		<div class="form-group" id="asing" hidden = "">
			<label class="col-sm-32 control-label nilaimu">Total Nilai Asing</label>
			<div class="col-sm-33" style="width:107px">
				<input type="text" name=""  id="kurs_tukar" readonly value = "<?php echo number_format($sub,2); ?>" autocomplete="off" class="form-control" placeholder = "Total Bayar ">
			</div>
		...
		<script type="text/javascript">
			$(function(){
				...
				$('#ongkir1,#tips,#nominal1,#nominal,#total_bayar').keyup(function(){
