 								...
 								<section class="col-lg-3 connectedSortable">
 									<div class="box box-primary box-solid">
 										<div class="box-header">
 											<h3 class="box-title"><i class="fa fa-tag"></i> Edit Klasifikasi Akun</h3>
 										</div>
 										...
 										<form class="form-horizontal" method="POST" action="">
 											<div class="box-body">
 												<div class="form-group">
 													...
 													<div class="col-sm-5">
 														<input type="text"  name="kode_akun" readonly value = "<?php echo $f['kode_akun'];?>" id="kode_akun" onkeyup="this.value=this.value.toUpperCase();" autocomplete="off" class="form-control" placeholder = "KODE AKUN" required oninvalid="this.setCustomValidity('Oops.. Data Tidak Boleh Kosong')" oninput="setCustomValidity('')">
 													</div>
 												</div>
 												<div class="form-group">
 													...
 													<div class="col-sm-5">
 														<select class="form-control" autofocus name = "kode_kategori" id="kode_kategori">
 															<option value = "<?php echo $f['kode_kategori'];?>"><?php echo $f['kode_kategori'];?></option>
 															<?php 
 												...
 												<div class="form-group">
 													...
 													<div class="col-sm-5">
 														<input type="text"  name="nama_akun" id="nama_akun" onkeyup="this.value=this.value.toUpperCase();" autocomplete="off" class="form-control" placeholder = "NAMA AKUN" required oninvalid="this.setCustomValidity('Oops.. Data Tidak Boleh Kosong')" oninput="setCustomValidity('')" autofocus value = "<?php echo $f['nama_akun'];?>">
 													</div>
 												</div>
 												<div class="form-group" hidden="">
 													<label class="col-sm-3 control-label">Klasifikasi</label>
 													<div class="col-sm-5">
 														<input type="text"  name="klasifikasi" id="nama_satuan" onkeyup="this.value=this.value.toUpperCase();" autocomplete="off" class="form-control" placeholder = "KLASIFIKASI" required oninvalid="this.setCustomValidity('Oops.. Data Tidak Boleh Kosong')" oninput="setCustomValidity('')" value = "<?php echo $f['klasifikasi'];?>">
 													</div>
 												</div>
 												<div class="form-group">
 														...
 														<table align = "right" class = "table1">
 															<tr>
 																<td align = "right">
 																	...
 																	<a href = "<?php echo base_url();?>Daftar_akun/input_akun" class = "btn btn-sm btn-danger">Cancel</a>
 																</td>
 															</tr>
 														</table>
 													</div>
