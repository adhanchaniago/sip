 ...
 <section class="col-lg-12 connectedSortable">
		<div class="box box-primary">
			<div class="nav-tabs-custom">
				...
				<li class=""><a href="<?php echo base_url(); ?>Penjualans/view_penjualan" ><i class="fa fa-cart-arrow-down"></i> <b>Data Penjualan</b></a></li>
				<?php endif;?>
				...
				<li class="active"><a href="<?php echo base_url(); ?>Penjualans/view_retur" data-toggle="tab"><i class="fa fa-mail-forward"></i> <b>Data Retur Penjualan</b></a></li>
				</ul>
			</div>
			</div>
...
<script type="text/javascript">
	tampiltmp();
		...
		$(".detail").click(function(){
			...
			$.ajax({
				type 	:'POST',
				url     :'<?php echo base_url();?>Penjualans/retur_detail',
