...
foreach ($list_tmp as $t) { 
	...
	<?php  $total=$total+$hasil3; $kom=$kom+$komisi2; $no++;} ?> 
	<td hidden = ""><input type="hidden" name="subtotaltemp" id="subtotaltemp" value="<?php echo $total;?>"></td>
	<td hidden = ""><input type="hidden" name="sub" id="sub" value="<?php echo round($kom);?>"></td>
