 	...
 	<div class = "row " >
 		<section class="col-lg-12 connectedSortable">
 			<div class="box box-primary" > 
 				<h3 class="box-title" style="margin-top:4px;margin-bottom:-19px;padding-bottom:4px;">Input PO</h3>
 			</div>
 			<div class="box-body">
 				<div class="col-md-7">
 					<form class="form-horizontal"  method="POST" action="" enctype = "multipart/form-data">
 						<div class="form-group">
 							...
 							<div class="col-sm-37">
 								<input type="text" name="no_po" id="no_po" autocomplete="off" readonly  class="form-control" placeholder = " No Jual" >
 							</div>
 							<label class="col-sm-40 control-label">Tanggal PO</label>
 							<div class="col-sm-37">
 								<input type="hidden" name="tgl_po"  value="<?php echo date('Y-m-d') ;?>"onFocus="startCalc();" onBlur="stopCalc();" autocomplete="off" readonly class="form-control" placeholder = " Tanggal Invoice">
 								<input type="text" name="" id = "" value="<?php echo date('d-m-Y') ;?>"onFocus="startCalc();" onBlur="stopCalc();" autocomplete="off" readonly class="form-control" placeholder = " Tanggal Invoice">
 					...
 					<div class="col-md-5">
 						<div class="col-sm-41">
 							<textarea  type="text"  name="alamat" id="send" rows="2" style="width: 207px; height: 70; " autocomplete="off" class="form-control"  placeholder = " Ship To (F1) " onkeyup=" this.value=this.value.toUpperCase();"></textarea>
 					...
 					<div class="col-md-9"  style="margin-top: -41px;" onsubmit="return validasi_input(this)">
 						...
 						<div class="col-sm-30" style="width:120px" >
 							<input type="text" name="hargajual" id="harga_jual"  autocomplete="off" class="form-control" placeholder = "Harga Jual" tabindex = "14">
 							
 						</div>
 						<div class="col-sm-30"  style="width:120px">
 							<input type="text" name="hargamodal" id="harga_modal" readonly autocomplete="off" class="form-control" placeholder = "Modal">
 						...
 						<div class="col-sm-35" style="width:80px"  >
 							...
 							<textarea rows="1" style = "display:none;" class="form-control" name="jam1" id="txt1" style="height: 34px;"readonly></textarea>
 						</div>
 						<div class="col-sm-31">
