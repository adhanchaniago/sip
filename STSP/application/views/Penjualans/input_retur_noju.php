 	...
 	<div class = "row " >
 		...
 		<section class="col-lg-12 connectedSortable">
 			<div class="box box-primary" > 
 				<h3 class="box-title" style="margin-top:4px;margin-bottom:-19px;padding-bottom:4px;">Retur Penjualan</h3>
 			</div>
 			<div class="box-body">
 				<div class="col-md-7">
 					<form class="form-horizontal"  method="POST" id="form" action="" enctype = "multipart/form-data">
 						<div class="form-group">
 							...
 							<div class="col-sm-37" style="width: 14%;margin-left: -5%;" >
 							...
 							<div class="col-sm-37" style="width: 14%;margin-left: -6%;">
 							...
 							<div class="col-sm-37" style="width: 14%;margin-left: -2%;">
 					...
 					<div class="col-md-9"  style="margin-top: -76px;">
 						...
 						<div class="col-sm-30" style="width:120px" >
 							...
 							<div class="col-sm-35" style="width:80px"  >
 								...
 								<input type="hidden"  name="disct1" id="disct1" onFocus="startCalc();" autocomplete="off" class="form-control" placeholder = "3" tabindex = "10"><textarea rows="1" style="display:none;" class="form-control" name="jam1" id="txt" style="height: 34px;"readonly></textarea>
 							</div>
 							<div class="col-sm-31">
 							...
 							$query = "SELECT * FROM tb_detail_penjualans 
 							INNER JOIN tb_penjualans ON tb_detail_penjualans.no_jual = tb_penjualans.no_jual 
 							INNER JOIN tb_barang ON tb_detail_penjualans.id_barang = tb_barang.id_barang 
 							WHERE tb_detail_penjualans.no_jual = '$no_jual' ORDER BY tb_detail_penjualans.tgl DESC";
 			...
 			<tr>
 				<td colspan = "7" align = "right"><b>Sisa Tagihan</b></td>
 				<td hidden=""><input type="hidden" name="sisatagihan" id="sisatagihan" value="<?php echo $f['sisa'];?>"></td>
 				<td align="right"><?php if($f['sisa'] > 0){
 				echo number_format($f['sisa'],2);
 			}else{
 				echo "0.00";
 			}?></td></tr>
 ...
 <div class="col-md-3" style="margin-top: -9px;">
 	...
 	<div class="form-group">
 		<table class = "table1">
 			<tr>
 				<td align = "right">
 					<input type="submit" name = "submit" id="btn_simpan1" value = "SIMPAN" class="btn btn-sm btn-primary" tabindex="28">
 				...
 				<?php endif;?>
 				<a href = "<?php echo base_url();?>Penjualan/riset_retur" class = "btn btn-sm btn-danger" tabindex="30">Cancel</a>
...
<script>
	...
	$(function(){
		...
		$('#nama_barang').autocomplete({
			serviceUrl: site+'Penjualans/get_data_retur_nojul/'+noju,
...
<script type="text/javascript">
	...
	function tampiltmp(){			
		...
		$("#tampiltmp").load("<?php echo base_url();?>Penjualans/retur_tmp");
        $('.tampildata').load("<?php echo base_url();?>Penjualans/view_retur_total");
		$('.tampildata1').load("<?php echo base_url();?>Penjualans/view_detail_barang4");			
	}
	$('#btn_simpan').on('click',function(){
		...
		var qty				=parseInt($('#qty').val());
           ...
           if(namabarang == 0){
			 ...
			 alert("Oops.. Retur Barang Lebih");
           	document.getElementById("Q_B").focus();
		   }else{
           	$.ajax({
           		type : "POST",
           		url  : "<?php echo base_url();?>Penjualans/input_detail_retur1",
   ...
   <script>
   	...
   	$('body').on('click', '.hapus-barang', function(e){
   		...
   		$.ajax({
   			type: 'post',
   			dataType: 'json',
   			url : "<?= site_url('Penjualans/destroy4/');?>"+'/'+user+'/'+id_barang,
   			success: function(data){
   				tampiltmp();
   				$('.tampildata').load("<?php echo base_url();?>Penjualans/view_retur_total");
   				$('.tampildata1').load("<?php echo base_url();?>Penjualans/view_detail_barang4");
