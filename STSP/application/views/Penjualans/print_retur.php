...
<form class="form-horizontal"  method="POST" action="<?php echo base_url();?>Penjualans/update_cetak_retur" target = "" enctype = "multipart/form-data">
							<div class="form-group">
								<label class="col-sm-3 control-label">Alasan Print</label>
								<div class="col-sm-5">
										<?php foreach ($cetak->result() as $r) {  ?>
										<input type="hidden" value = "<?php echo $r->no_retur; ?>" name="no_retur" id="#" autocomplete="off" class="form-control" placeholder = "Masukan Alasan">
										<?php } ?>
