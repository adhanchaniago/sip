...
<style type="text/css">
		...
		<!-- onload="window.print();window.location.href = '<?php echo base_url('Surat_jalan/view_sj_retur');?>';" -->
<div class = "page">
...
<table align="left" width="900px"  >
	<tr id="FC" height="20px">
		...
		<td align="left" width = "20%"><b>Diambil</b></td>
	</tr>
	...
	<td height="10"> </td>
					...
					<form class="form-horizontal"  method="POST" action="" enctype = "multipart/form-data" >
							<div class="form-group" id="FC">
								<td><?php echo $d['no_sj_retur'];?>/<?php echo $d['id_pelanggan'];?></td>
							<div class="col-sm-42" >
								<td>No RSJ</td>
							</div>
							</div>
							<div class="form-group" id="FC">
								<td><?php echo $d['no_sj'];?>/<?php echo $d['id_pelanggan'];?>/<?php echo $d['no_sjln'];?></td>
							<div class="col-sm-42" >
								<td>No SJ</td>
							</div>
							</div>
